...
document.addEventListener("DOMContentLoaded",function(){let t=document.querySelector(".intro-loader"),e=document.querySelector(".intro-logo");t&&e&&setTimeout(()=>{e.style.transition="all 0.6s ease",e.style.transform="translateY(-50px)",e.style.opacity="0",setTimeout(()=>{t.style.transition="opacity 0.5s ease",t.style.opacity="0",setTimeout(()=>{t.style.display="none"},500)},600)},1e3)});