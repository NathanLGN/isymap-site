...
document.addEventListener("DOMContentLoaded",function(){let e=document.querySelector(".intro-loader"),t=document.querySelector(".intro-logo"),a=window.location.pathname,l=a.endsWith("/")||a.endsWith("/index.html");e&&t&&l?(document.body.classList.replace("loading-page-template","page-template"),setTimeout(()=>{t.style.transition="all 0.6s ease",t.style.transform="translateY(-50px)",t.style.opacity="0",setTimeout(()=>{e.style.transition="opacity 0.5s ease",e.style.opacity="0",setTimeout(()=>{e.style.display="none"},500)},600)},1e3)):e&&(e.remove(),document.body.classList.replace("loading-page-template","page-template"))});