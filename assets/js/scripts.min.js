...
document.addEventListener("DOMContentLoaded",function(){let e=document.querySelector(".intro-loader"),t=document.querySelector(".intro-logo"),n=window.location.pathname,o=n.endsWith("/")||n.endsWith("/index.html");e&&t&&o?setTimeout(()=>{t.style.transition="all 0.6s ease",t.style.transform="translateY(-50px)",t.style.opacity="0",setTimeout(()=>{e.style.transition="opacity 0.5s ease",e.style.opacity="0",setTimeout(()=>{e.style.display="none"},500)},600)},1e3):e&&e.remove()});