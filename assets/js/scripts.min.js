...
document.addEventListener("DOMContentLoaded",function(){let e=document.querySelector(".intro-loader"),o=document.querySelector(".intro-logo"),a=window.location.pathname,h=a.endsWith("/")||a.endsWith("/index.html");e&&o&&h?(document.body.classList.replace("loading-page-template","page-template"),setTimeout(()=>{o.style.transition="all 0.6s ease",o.style.transform="translateY(-50px)",o.style.opacity="0",setTimeout(()=>{e.style.transition="opacity 0.5s ease",e.style.opacity="0",setTimeout(()=>{e.style.display="none"},500)},600)},1e3)):e&&(e&&e.remove(),setTimeout(()=>{document.body.classList.replace("loading-page-template","page-template")},1)),anime({targets:".home-hero-logo",opacity:[0,1],duration:2e3,easing:"linear"}),$(".home-hero .home-hero-word-6").addClass("is-animating"),$(".home-hero .home-hero-word-7").addClass("is-animating"),$(".home-hero .home-hero-word-2").addClass("is-animating"),$(".home-hero .home-hero-word-10").addClass("is-animating"),$(".home-hero .home-hero-word-4").addClass("is-animating"),$(".home-hero .home-hero-word-8").addClass("is-animating"),$(".home-hero .home-hero-word-3").addClass("is-animating"),$(".home-hero .home-hero-word-5").addClass("is-animating"),$(".home-hero .home-hero-word-1").addClass("is-animating"),$(".home-hero .home-hero-word-9").addClass("is-animating"),setInterval(()=>{$(".home-hero .home-hero-word-6").removeClass("is-animating"),$(".home-hero .home-hero-word-7").removeClass("is-animating"),$(".home-hero .home-hero-word-2").removeClass("is-animating"),$(".home-hero .home-hero-word-10").removeClass("is-animating"),$(".home-hero .home-hero-word-4").removeClass("is-animating"),$(".home-hero .home-hero-word-8").removeClass("is-animating"),$(".home-hero .home-hero-word-3").removeClass("is-animating"),$(".home-hero .home-hero-word-5").removeClass("is-animating"),$(".home-hero .home-hero-word-1").removeClass("is-animating"),$(".home-hero .home-hero-word-9").removeClass("is-animating"),setTimeout(()=>{$(".home-hero .home-hero-word-6").addClass("is-animating"),$(".home-hero .home-hero-word-7").addClass("is-animating"),$(".home-hero .home-hero-word-2").addClass("is-animating"),$(".home-hero .home-hero-word-10").addClass("is-animating"),$(".home-hero .home-hero-word-4").addClass("is-animating"),$(".home-hero .home-hero-word-8").addClass("is-animating"),$(".home-hero .home-hero-word-3").addClass("is-animating"),$(".home-hero .home-hero-word-5").addClass("is-animating"),$(".home-hero .home-hero-word-1").addClass("is-animating"),$(".home-hero .home-hero-word-9").addClass("is-animating")},100)},10950)});