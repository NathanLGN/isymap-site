...
const modal=document.getElementById("exampleModal"),iframe=document.getElementById("youtubeVideo");modal.addEventListener("show.bs.modal",(()=>{iframe.src=iframe.dataset.src})),modal.addEventListener("hidden.bs.modal",(()=>{iframe.src=""}));