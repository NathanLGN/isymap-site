...
$("#exampleModal").on("hidden.bs.modal",(function(){$("#youtubeVideo").attr("src","")})),$("#exampleModal").on("show.bs.modal",(function(){$("#youtubeVideo").attr("src",$("#youtubeVideo").data("src"))})),modal.addEventListener("hidden.bs.modal",(()=>{console.log("MODALE FERMÉE")}));