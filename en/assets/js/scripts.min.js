...
const modal=document.getElementById("exampleModal");modal.addEventListener("hidden.bs.modal",(function(){const e=modal.querySelector("iframe"),t=e.getAttribute("src");e.setAttribute("src",t)}));