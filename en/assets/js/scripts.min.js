...
const modal=document.getElementById("exampleModal"),iframe=document.getElementById("youtubeVideo"),src=iframe.src;modal.addEventListener("hide.bs.modal",(function(){iframe.src=""})),modal.addEventListener("show.bs.modal",(function(){iframe.src=src})),modal.addEventListener("hidden.bs.modal",(()=>{console.log("MODALE FERMÉE")}));