...
$("#exampleModal").on("hide.bs.modal",(function(){$("#youtubeVideo").attr("src","")})),$("#exampleModal").on("show.bs.modal",(function(){const o=$("#youtubeVideo");o.attr("src",o.data("src"))})),$("#exampleModal").on("hide.bs.modal",(function(){console.log("STOP VIDEO IMMEDIAT")}));